    ...
    public class user_name
    {
        ...
        {//start of
            ...
            {//start of if
                ...
                error_method("CyberKore", "Hey " + name + "  welcome to AI cybersecurity", chats);
            ...
            {//start of else
                ...
                error_method("CyberKore ", "Hey " + name + " welcome back, how can i help you today", chats);
        ...
        {//star of error mehtod
            ...
            if (name.ToLower().Contains("cyberkore") || name.ToLower().Contains("chat"))
            {//  blue for ai bot
                messageBorder.Background = new SolidColorBrush(Color.FromRgb(0, 120, 215));
                messageBorder.BorderBrush = new SolidColorBrush(Color.FromRgb(0, 90, 170));
            }
            else
            {    // black for user
                messageBorder.Background = new SolidColorBrush(Color.FromRgb(0, 0, 0));
                messageBorder.BorderBrush = new SolidColorBrush(Color.FromRgb(50, 50, 50));
            }
            ...
            Brush nameColor = (name.ToLower().Contains("cyberkore") || name.ToLower().Contains("chat")) ?
                              Brushes.AntiqueWhite : Brushes.SkyBlue;
